package com.trippy.auth.integration.web
...
import com.trippy.auth.generated.application.web.dtos.ErrorV1
...
import com.trippy.auth.integration.IntegrationTest
import com.trippy.auth.integration.utils.SpringMailMock
...
class UserIntegrationTest : IntegrationTest() {
    ...
    fun `given a user request when the first name is empty should return status 400`() {
        ...
        val response = given()
            .contentType("application/vnd.trippy_auth_api_user_v1+json")
