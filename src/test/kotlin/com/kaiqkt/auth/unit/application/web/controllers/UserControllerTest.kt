...
import com.kaiqkt.auth.application.web.controllers.UserController
...
class UserControllerTest {
    ...
    @Test
    fun `given a request to reset password form should return the reset password form`() {
        val code = "code"

        val response = userController.resetPasswordForm(code)
